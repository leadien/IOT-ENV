/**************************************************************************************************
  Filename:       nwk_ping.h
  Revised:        $Date: 2007-12-13 16:32:44 -0800 (Thu, 13 Dec 2007) $
  Revision:       $Revision: 16074 $
...
#define MAX_PING_APP_FRAME    (2+6)

/* application payload offsets */
/*    both */
#define PB_APP_INFO_OS     0
#define PB_TID_OS          1
#define PB_RSSI_OS          2
#define PB_LQI_OS          3
#define PB_DST_ADDRESS_OS          4
