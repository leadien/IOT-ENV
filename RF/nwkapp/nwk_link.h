...
#define L_MY_NODETYPE_OS        8
/*    link reply frame */
#define LR_RMT_PORT_OS         2
#define LR_MY_RXTYPE_OS        3
#define LR_MY_NODETYPE_OS        4
#define LR_TIME_STAMP_OS        5

/* change the following as protocol developed */
#define MAX_LINK_APP_FRAME     (8+1)//8

/* frame sizes */
#define LINK_FRAME_SIZE         (8+1)// 8
#define LINK_REPLY_FRAME_SIZE   (4+1+4) // 4 
