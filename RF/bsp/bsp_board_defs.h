 ...
 * ------------------------------------------------------------------------------------------------
 */
//changed for SPMP3050 by cbwang@20080603
//#include "mcus/bsp_msp430_defs.h"
//#include "mcus/bsp_spmp3050_defs.h"
//end
...
//#define BSP_DELAY_USECS(x)      hwWait(2, x)   //BSP_Delay(x)
#define BSP_DELAY_USECS(x)      uDelay(x)   //BSP_Delay(x)
//#define BSP_DELAY_MSECS(x)      MsDelay(x)   //BSP_Delay(x)
#define BSP_DELAY_MSECS(x)      mDelay(x)   //BSP_Delay(x)
