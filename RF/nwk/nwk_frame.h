...
Revised:        $Date: 2008-01-04 11:04:37 -0800 (Fri, 04 Jan 2008) $
Revision:       $Revision: 16150 $
...
#define F_PORT_OS         0
#if 0
#define F_PORT_OS_MSK     (0x3F)	// max suport 64 port number
#else
#define F_PORT_OS_MSK     (0xFF)  // max suport 256 port number
#endif
