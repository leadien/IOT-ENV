...
const uint32_t GPIO_CLK[LEDn] = {LED1_GPIO_CLK, LED2_GPIO_CLK, LED3_GPIO_CLK,
 ...
 USART_TypeDef* COM_USART[COMn] = {EVAL_COM1, EVAL_COM2, EVAL_COM2};

 GPIO_TypeDef* COM_PORT[COMn] = {EVAL_COM1_GPIO, EVAL_COM2_GPIO, EVAL_COM3_GPIO};

 const uint32_t COM_USART_CLK[COMn] = {EVAL_COM1_CLK, EVAL_COM2_CLK, EVAL_COM3_CLK};

 const uint32_t COM_POR_CLK[COMn] = {EVAL_COM1_GPIO_CLK, EVAL_COM2_GPIO_CLK, EVAL_COM3_GPIO_CLK};

 const uint16_t COM_TX_PIN[COMn] = {EVAL_COM1_TxPin, EVAL_COM2_TxPin, EVAL_COM3_TxPin};

 const uint16_t COM_RX_PIN[COMn] = {EVAL_COM1_RxPin, EVAL_COM2_RxPin, EVAL_COM3_RxPin};
...
void STM_EVAL_LEDInit(Led_TypeDef Led)
{
  ...
  /* armfly : STM32F103ZE-EK第1版本和官方开发板的LED是反相的，因此添加关闭LED的语句	*/
  STM_EVAL_LEDOff(Led);
}
...
{
  /* armfly : STM32F103ZE-EK 第1版和官方是反相的 */
  #if 1
...
/**
  ...
  * @retval None
  */
void STM_EVAL_LEDSet(Led_TypeDef Led, uint32_t val)
{
	if(val==0)GPIO_PORT[Led]->BSRR = GPIO_PIN[Led];
	else if(val==1)GPIO_PORT[Led]->BRR = GPIO_PIN[Led];
