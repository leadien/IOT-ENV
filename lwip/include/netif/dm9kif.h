...
#define DM9000_IMR_SET        0x83                /* 设定 启用中断使能 条件设置 */
//#define DM9000_IMR_SET        0xa3                /* 设定 启用中断使能 条件设置 */
//#define DM9000_IMR_SET        0x87                /* 设定 启用中断使能 条件设置 */
#define DM9000_IMR_OFF        0x80                /* 设定 关闭中断使能 条件设置 */

#define DM9000_IRQ_PIN				GPIO_Pin_1
#define DM9000_IRQ_LINE			EXTI_Line1
//#define MRFI_GDO0_PIN_LINE		MRFI_GDO0_PIN
#define DM9000_IRQ_PIN_SOURCE		GPIO_PinSource1
#define DM9000_IRQ_CHANNEL		EXTI1_IRQn
#define DM9000_IRQ_PORT			GPIOA
#define DM9000_IRQ_PORT_CLK		RCC_APB2Periph_GPIOA
#define DM9000_IRQ_PORT_SOURCE	GPIO_PortSourceGPIOA
#define DM9000_IRQ_TRIGGER			EXTI_Trigger_Falling
